...
VALUES
   (1,"user01","pass01","홍길동","남","010-1234-5678",null),
    (2,"user02","pass02","유관순","여","010-1234-5678",null);
...
(user_no,user_id,user_pwd,user_name,gender,phone,email)
VALUES
   (null,"user01","pass01","홍길동","남","010-1234-5678",null);
...
INSERT INTO user_foreignkey1
  ...
  VALUES
   (1,"user01","pass01","홍길동",'남',"010-1234-5678",null,30),
...
VALUES
    ...
    -- DEFAULT
    -- 컬럼에 null 대신에 기본값 적용
    -- 컬럼 타입이 DATE 일경우 -current_date 만 사용가능
    -- DATETIME 일 경우 -current_time,current_timeamp,now() 모두 가능 
